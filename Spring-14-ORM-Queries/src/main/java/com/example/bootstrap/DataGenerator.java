...
public class DataGenerator implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        System.out.println("departmentRepository = " + departmentRepository.findByDivisionIs("Outdoors"));
        ...
        System.out.println("getEmployeeDetail:" + employeeRepository.findByEmail("emails"));
        System.out.println("employeeRepository = " + employeeRepository.findByFirstNameAndLastNameOrEmail("Berrie","Manueau","bmanueau0@dion.ne.jp"));
     //   System.out.println("args = " +employeeRepository.findByFirstNameIsNot("Berrie"));
